...
export default {
	core: {
		...
		hello: name => name ? `ごきげんよう、${name}♪` : `ごきげんよう♪`,
...
*/
		...
		okaeri: {
			...
			love2: name => name ? `おかえりなさいませ♡お待ちしておりました♡${name}っっ♡` : 'おかえりなさいませ♡お待ちしておりました♡ご主人様っっ♡',
		...
		nadenade: {
			...
			love2: ['わわっ… 恥ずかしいです', 'あうぅ… 恥ずかしいです…', 'ふやぁ…？', 'えへへ…すきです……♡'],

			love3: ['んぅ… ありがとうございます♪', 'えへへへへ……♡', 'だいすき…', 'おてて、あったかいです…', 'えへへ…もっと…♡'],
		...
		kawaii: {
			normal: ['ど、どうしたんですか急に！？', 'ありがとうございます、えへへ...'],

			love: ['嬉しいです♪', '照れちゃいます...', 'えへへ♪'],
		...
		hug: {
			normal: 'わわっ、びっくりしました...！ぎゅー...！',

			love: ['ぎゅーっ♪', 'えへへ、あったかいです♪'],
		...
		itai: name => name ? `${name}、大丈夫ですか…？ よしよし…` : 'わっ、大丈夫ですか…？ よしよし…',

		nemui: {
			normal: ['はやく寝ないと、明日に響きますよ？', '毛布いりますか？'],

			love1: ['寝ちゃうん...ですか...？', 'さみしいです...'],
			
			love2: ['わたしと一緒に寝ますか？', '添い寝...しませんか？']
		},
		...
		transferNeedDm: 'わかりました、DMで話しましょう',
